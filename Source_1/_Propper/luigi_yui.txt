About:
This is a voxel art version of a sprite edit I did for my GameBanana avatar, wherein I removed his 
moustache. The palette texture is designed to be point-sampled.

Legalese:
Original Luigi sprite from Super Mario World © Nintendo. Mustache removed by SirYodaJedi. 
...
* Nu2 skeletal mesh, PC format (_PC.GSC)
* Nu2 static mesh, NXG format (_NXG.GSC)
* Nu2 skeletal mesh, NXG format (_NXG.GSC)
